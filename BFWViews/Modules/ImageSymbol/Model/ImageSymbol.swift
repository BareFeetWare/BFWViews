...
public extension ImageSymbol {
    ...
    static let battery50: Self = .init("battery.50")
    static let battery75: Self = .init("battery.75")
    ...
    static let minus: Self = .init("minus")
    ...
    static let powerplug: Self = .init("powerplug")
    static let powerplugPortrait: Self = .init("powerplug.portrait")
